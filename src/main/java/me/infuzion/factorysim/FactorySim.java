...
//        init.initRenderer(spriteLoader);
        ...
        KeyHandler handler = new KeyHandler(world);
        context.getCanvas().addEventHandler(KeyEvent.KEY_PRESSED, handler::onKeyPress);
        context.getCanvas().addEventHandler(KeyEvent.KEY_RELEASED, handler::onKeyRelease);
